        ...
        withDb(excludeSettings = columnTypeChangeUnsupportedDb) {
            try {
                ...
                columnsMetadata.forEachIndexed { index, columnMetadataItem ->
                    ...
                    assertTrue(currentDialectTest.areEquivalentTypes(columnMetadataSqlType, columnMetadataItem.jdbcType, columnType))
                }
            ...
            columns.forEach { oldColumn ->
                ...
                withTables(oldTable) {
                    ...
                    for (newColumn in columns) {
                        if (currentDialectTest.areEquivalentTypes(oldColumnMetadataItem.sqlType, oldColumnMetadataItem.jdbcType, newColumn.columnType.sqlType())) {
                            continue
                        }
