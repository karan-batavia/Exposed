...
import org.jetbrains.exposed.sql.tests.TestDB.entries
...
enum class TestDB(
    ...
    ORACLE(
        ...
        {
            ORACLE.connection()
                .replace("jdbc:oracle:thin:", "r2dbc:oracle://${ORACLE.user}:${ORACLE.pass}")
        },
    ...
    SQLSERVER(
        { "jdbc:sqlserver://127.0.0.1:3005" },
        {
            SQLSERVER.connection()
                .replace("jdbc:sqlserver://", "r2dbc:mssql://${SQLSERVER.user}:${SQLSERVER.pass}@")
        },
